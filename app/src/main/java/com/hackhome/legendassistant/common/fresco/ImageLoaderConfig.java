...
public class ImageLoaderConfig {
    ...
    protected static final int MAX_DISK_SMALL_CACHE_SIZE = 50 * ByteConstants.MB;

    protected static final int MAX_DISK_SMALL_ONLOWDISKSPACE_CACHE_SIZE = 10 * ByteConstants.MB;
